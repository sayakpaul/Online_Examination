...
<div style="font-weight: bold;color:red" id="status"></div>
<script>countDown(900,"status");</script>

</script>
<form action = result.php id = "myquiz" method = post onsubmit = "return checked()">
<?php
	$i = 1;
	$sub = $_REQUEST['n1'];
